...
\input{tex/model_metrics_table_naive_bayes}
\input{tex/model_metrics_table_logistic_regression}
\input{tex/model_metrics_table_support_vector_machine}
\input{tex/model_metrics_table_random_forest}
